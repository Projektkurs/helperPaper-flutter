          ...
          borderRadius:
              MediaQuery.of(context).orientation == Orientation.portrait
                  ...
                  : const BorderRadius.horizontal(
                      right: Radius.circular(9999), left: Radius.circular(400)),
        ),
    ...
    ExpansionTile(title: const Text('Border'), children: [
      ListTile(
          ...
          trailing: SizedBox(
              width: (Theme.of(context).textTheme.titleSmall!.fontSize ?? 16) *
                  2.5,
              child: Text(
                  (generalconfig.borderWidth ?? globalgconf.borderWidth!)
                      .toStringAsFixed(2))),
          title: Slider(
              value: generalconfig.borderWidth ?? globalgconf.borderWidth!,
              onChanged: (double value) {
                setState(() {
                  generalconfig.borderWidth = value;
                });
              },
              min: 0,
              max: 10)),
      ListTile(
          ...
          trailing: SizedBox(
              width: (Theme.of(context).textTheme.titleSmall!.fontSize ?? 16) *
                  2.5,
              child: Text(
                  (generalconfig.borderRadius ?? globalgconf.borderRadius!)
                      .toStringAsFixed(2))),
          title: Slider(
              value: generalconfig.borderRadius ?? globalgconf.borderRadius!,
              onChanged: (double value) {
                setState(() {
                  generalconfig.borderRadius = value;
                });
              },
              min: 0,
              max: 30)),
      ...
      ListTile(
        ...
        onTap: () {
          colorDialog(
                  context,
                  generalconfig.borderColor ??
                      const Color.fromARGB(255, 73, 73, 73),
                  setState)
              .then((value) => setState(() {
                    generalconfig.borderColor = value;
                  }));
        },
      ),
    ]),
